...
enum
{
    ...
    S_GIBBOUNCE, S_GRNBOUNCE,

    S_SHBCRIFLE, S_SHBCPISTOL, S_SHBCSHOTG,

    S_DISTANTMG, S_DISTANTSG, S_DISTANTRIF, S_DISTANTPIS, S_DISTANTRL, S_DISTANTGL,
    S_DISTANTEXP, S_DISTANTGREN,

    S_RICOCHET,

    S_DISCONNECT, S_CONNECT, S_CHAT, S_CHATTEAM, S_MENUHOVER, S_MENUCLICK, S_MENUTIMER, S_GAMEOVER, S_GAMESTART,
