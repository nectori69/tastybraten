...
static partrenderer *parts[] = 
{
    ...
    &meters,                                                                                       // meter
    &metervs,                                                                                      // meter vs.
    new quadrenderer("<grey>packages/particles/smoke.png", PT_PART | PT_FLIP),                     // smoke additive
    new quadrenderer("<grey>packages/particles/steam.png", PT_PART | PT_FLIP | PT_MOD),            // blood mist
